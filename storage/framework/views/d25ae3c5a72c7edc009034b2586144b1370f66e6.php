                        ...
                        <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
                          ...
                          <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-label-group">
                              ...
                              <input name="email" id="useremail" aria-describedby="useremailHelp" type="text" placeholder="Correo electrónico" value="<?php echo e(old('email')); ?>" class="form-control <?= isset($errores['email']) ? 'errores-form-sr':'' ?>">
